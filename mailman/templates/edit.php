      ...
      <div class="row-fluid">
        <form action="<?php echo get_app_info('path')?>/includes/create/save-campaign.php?i=<?php echo get_app_info('app')?>&c=<?php echo $cid;?>&edit=true" method="POST" accept-charset="utf-8" class="form-vertical" id="edit-form" enctype="multipart/form-data">
          <div class="span3">
            ...
            <div id="campaign-title-field" style="<?php if(get_saved_data('label')=='') echo 'display:none;'?>">
              ...
              <div class="control-group">
                <div class="controls">
                      <input type="text" class="input-xlarge" id="campaign_title" name="campaign_title" placeholder="Title of this campaign" value="<?php echo htmlspecialchars(get_saved_data('label'));?>">
                    </div>
                </div>
              </div>
            ...
            <div class="control-group">
              <div class="controls">
                    <input type="text" class="input-xlarge" id="subject" name="subject" placeholder="Subject of this email" value="<?php echo htmlspecialchars(get_saved_data('title'));?>">
                  </div>
              </div>
          ...
          <?php endif;?>
            ...
            <div class="control-group">
              <div class="controls">
                    <input type="text" class="input-xlarge" id="from_name" name="from_name" placeholder="From name" value="<?php echo get_saved_data('from_name');?>">
                  </div>
              </div>
            ...
            <div class="control-group">
              <div class="controls">
                    <input type="text" class="input-xlarge" <?php if(get_app_info('is_sub_user')) echo 'readonly="readonly"';?> id="from_email" name="from_email" placeholder="From email" value="<?php echo get_saved_data('from_email');?>">
                  </div>
              </div>
            ...
            <div class="control-group">
              <div class="controls">
                    <input type="text" class="input-xlarge" id="reply_to" name="reply_to" placeholder="Reply to email" value="<?php echo get_saved_data('reply_to');?>">
                  </div>
              </div>
              ...
              <label class="control-label" for="plain">Plain text</label>
                <div class="control-group">
              <div class="controls">
                    <textarea class="input-xlarge" id="plain" name="plain" rows="10" placeholder="Plain text of this email"><?php echo get_saved_data('plain_text');?></textarea>
                  </div>
              </div>
          ...
          <div class="span9">
            <p>
              ...
              <button class="btn" id="toggle-wysiwyg">Save and switch to HTML editor</button> <?php echo $html_code_msg;?>
            <?php else:?>
              <button class="btn" id="toggle-wysiwyg">Save and switch to WYSIWYG editor</button> <?php echo $html_code_msg;?>
            <?php endif;?>
            <script type="text/javascript">
              $("#toggle-wysiwyg").click(function(e){
                ...
                $.post('{{ STATIC_URL }}/includes/create/toggle-wysiwyg.php', { toggle: $("#toggle-wysiwyg").text(), i:"<?php echo get_app_info('app');?>", c: "<?php echo $cid;?>" },
                  function(data) {
                      if(data)
                      {
                        $("#edit-form").submit();
            ...
            <br/>
                  <div class="control-group">
                <div class="controls">
                      <textarea class="input-xlarge" id="html" name="html" rows="10" placeholder="Email content"><?php echo get_saved_data('html_text');?></textarea>
                    </div>
                </div>

...
<script src="{{ STATIC_URL }}/js/lists/editor.js?7"></script>
...
<div class="row-fluid">
    ...
    <div class="span10">
	    ...
	    <div class="row-fluid">
		    ...
		    <div class="span12">
		    	...
		    	<div class="control-group">
			    	<div class="controls">
		              <input type="text" class="input-xlarge" id="list_name" name="list_name" placeholder="The list name" value="<?php echo get_lists_data('name', $_GET['l']);?>">
		            </div>
		        </div>
	    ...
	    <div class="row-fluid">
	    	...
	    	<div class="span4">
		    	<label class="control-label"><strong>List type</strong></label>
		        <div class="well">
		        ...
		        <label class="control-label" for="subscribed_url"><strong>Subscribe success page</strong></label>
		        <div class="well">
		        	...
		        	<label class="control-label" for="subscribed_url">Page URL</label>
			    	<div class="control-group">
				    	<div class="controls">
			        ...
			        <div class="well" style="background: #FFFDEC;">
			        	...
			        	<p>Example:<br/><pre>http://domain.com/subscribed.php?name=%n&email=%e&listid=%l</pre></p>
		        ...
		        <label class="control-label" for="subscribed_url"><strong>Subscription confirmed page</strong> (<?php echo _('only applies for double opt-ins');?>)</label>
		        <div class="well">
		        	...
		        	<label class="control-label" for="confirm_url">Page URL</label>
			    	<div class="control-group">
				    	<div class="controls">
			        ...
			        <div class="well" style="background: #FFFDEC;">
			        	...
			        	<p>Example:<br/><pre>http://domain.com/confirmed.php?name=%n&email=%e&listid=%l</pre></p>
			        	<p><?php echo _('<code>%n</code> will be converted into the subscriber\'s name. <code>%e</code> will be converted into the \'email\' and <code>%l</code> will be converted into the \'listID\' that subscribed');?>.</p>
		        	</div>
		        </div>
	    	</div>
		    ...
		    <div class="span8">
			  ...
			  <label class="control-label" for="thankyou_subject"><strong>Thank you email subject</strong></label>
		    	<div class="control-group">
			    	<div class="controls">
		              <input type="text" class="input-xlarge" id="thankyou_subject" name="thankyou_subject" placeholder="Email subject" style="width: 98%;" value="<?php echo get_lists_data('thankyou_subject', $_GET['l']);?>">
		            </div>
		        </div>
			  
			  <label class="control-label" for="thankyou_message"><strong>Thank you email message</strong></label>
			  <div class="control-group">
			    	<div class="controls">
			          <textarea class="input-xlarge" id="thankyou_message" name="thankyou_message" rows="10" placeholder="Email message">
			  ...
			  <label class="control-label" for="confirmation_subject"><strong>Confirmation email subject</strong> (<?php echo _('only applies for double opt-ins');?>)<br/><em>* <?php echo _('A generic subject line will be used if you leave this field empty.');?></em></label>
		    	<div class="control-group">
			    	<div class="controls">
		              <input type="text" class="input-xlarge" id="confirmation_subject" name="confirmation_subject" placeholder="Subject of confirmation email" style="width: 98%;" value="<?php echo get_lists_data('confirmation_subject', $_GET['l']);?>">
		            </div>
		        </div>
			    
			  <label class="control-label" for="confirmation_email"><strong><?php echo _('Double Opt-In confirmation message');?></strong> (<?php echo _('only applies for double opt-ins');?>)<br/><em>* <?php echo _('A generic email message will be used if you leave this field empty.');?></em><br/><em>* <?php echo _('Don\'t forget to include the confirmation link tag');?> </em><code id="confirmation_link_tag">[confirmation_link]</code><em> somewhere in your message</em>.</label>
				<script type="text/javascript">
				$(document).ready(function() {
			  ...
			  <div class="control-group">
			    	<div class="controls">
			          <textarea class="input-xlarge" id="confirmation_email" name="confirmation_email" rows="10" placeholder="Email message">
	    ...
	    <div class="row-fluid">
	    	...
	    	<div class="span4">
		    	<label class="control-label"><strong>Unsubscribe user</strong></label>
		        <div class="well">
		        	...
		        	<p>
				    	<div class="btn-group" data-toggle="buttons-radio">
						  <a href="javascript:void(0)" title="" class="btn" id="this-list"><i class="icon icon-minus"></i> Only this list</a>
						  <a href="javascript:void(0)" title="" class="btn" id="all-list"><i class="icon icon-reorder"></i> All lists</a>
						</div>
						<script type="text/javascript">
							$(document).ready(function() {
								<?php 
		         ...
		         <label class="control-label" for="unsubscribed_url"><strong>Unsubscribe confirmation page</strong></label>
		        <div class="well">
			        ...
			        <div class="well" style="background: #FFFDEC;">
			        	...
			        	<p>Example:<br/><pre>http://domain.com/unsubscribed.php?email=%e&listid=%l</pre></p>
		    ...
		    <div class="span8">
			  ...
			  <label class="control-label" for="goodbye_subject"><strong>Goodbye email subject</strong></label>
		    	<div class="control-group">
			    	<div class="controls">
		              <input type="text" class="input-xlarge" id="goodbye_subject" name="goodbye_subject" placeholder="Email subject" style="width: 98%;" value="<?php echo get_lists_data('goodbye_subject', $_GET['l']);?>">
		            </div>
		        </div>
			  
			  <label class="control-label" for="goodbye_message"><strong>Goodbye email message</strong></label>
			  <div class="control-group">
			    	<div class="controls">
			          <textarea class="input-xlarge" id="goodbye_message" name="goodbye_message" rows="10" placeholder="Email message">
...
<div class="row-fluid">
	<div class="span2"></div>
	<div class="span10">
		<button type="submit" class="btn btn-inverse" style="float:right;"><i class="icon-ok icon-white"></i> Save</button>
	</div>
</div>

<?php
    if(ini_get('display_errors'))
		echo '<span class="label label-important"><i class="icon-remove icon-white"></i> display_errors is turned on</span>';
	else
	{
		echo '<span class="label label-success"><i class="icon-ok icon-white"></i> display_errors is turned off</span>';
    }
?>
